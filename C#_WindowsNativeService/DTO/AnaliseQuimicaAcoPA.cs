...
namespace CPS_AnaliseQuimica.DTO
{
    ...
    //  @Descricao:                                                                                              //
    // ********************************************************************************************************* //
    public class AnaliseQuimicaAcoPA
    {
        ...
        public AnaliseQuimicaAcoPA(Nullable<long> CORRIDA, String ACO, Nullable<decimal> S, Nullable<decimal> C, Nullable<decimal> MN, Nullable<decimal> P, Nullable<decimal> SI, 
            Nullable<decimal> AL, Nullable<decimal> N, Nullable<decimal> B, Nullable<decimal> NB, Nullable<decimal> TI, Nullable<decimal> CU, Nullable<decimal> CR, Nullable<decimal> MO, 
            Nullable<decimal> NI, Nullable<decimal> V, Nullable<decimal> CA, Nullable<decimal> SN, Nullable<decimal> CX, String TURMA, Nullable<long> TURNO, String AMOSTRA, 
            Nullable<DateTime> DATA, String codCentro, String processo, String aplicacao, String acoLing, String teorP, String teorC, String consumLigas, Nullable<decimal> ps)
        {
            this.id = 0;
