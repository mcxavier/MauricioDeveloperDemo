...
namespace Infra.Migrations
{
    ...
    [Migration("20200729161930_v0002")]
    partial class v0002
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Models.Catalogs.Catalog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Models.Catalogs.CatalogCustomer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Models.Catalogs.CatalogProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Models.Customers.Seller", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Models.Geography.Address", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Models.Messages.Conversation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Models.Messages.ConversationMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Models.Ordering.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Models.Ordering.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Models.Ordering.OrderItemDiscount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Models.Ordering.OrderItemDiscountType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Models.Ordering.OrderShipping", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Models.Ordering.OrderStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Models.Ordering.OrderType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Models.Payments.PaymentStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Models.Payments.PaymentTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Models.Payments.PaymentTransactionStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Models.Payments.PaymentTransactionSupplierCodeType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Models.Payments.PaymentType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Models.Products.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Models.Products.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Models.Products.ProductCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Models.Products.ProductImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Models.Products.ProductSpecification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Models.Products.ProductSpecificationType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Models.Products.ProductVariation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Models.Products.Stock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Models.Catalogs.CatalogCustomer", b =>
                {
                    b.HasOne("Core.Models.Catalogs.Catalog", "Catalog")
                        .WithMany("Customers")
                        .HasForeignKey("CatalogId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Core.Models.Customers.Customer", "Customer")
                        .WithMany()
            ...
            modelBuilder.Entity("Core.Models.Catalogs.CatalogProduct", b =>
                {
                    ...
                    b.HasOne("Core.Models.Catalogs.Catalog", null)
                        .WithMany("Products")
                        .HasForeignKey("CatalogId1");

                    b.HasOne("Core.Models.Products.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("Core.Models.Messages.ConversationMessage", b =>
                {
                    b.HasOne("Core.Models.Messages.Conversation", "Conversation")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("Core.Models.Ordering.Order", b =>
                {
                    ...
                    b.HasOne("Core.Models.Customers.Customer", null)
                        .WithMany("Orders")
                        .HasForeignKey("CustomerId1");

                    b.HasOne("Core.Models.Ordering.OrderType", "OrderType")
                        .WithMany()
                        .HasForeignKey("OrderTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Core.Models.Payments.Payment", "Payment")
                        .WithOne("Order")
                        .HasForeignKey("Core.Models.Ordering.Order", "PaymentId");

                    b.HasOne("Core.Models.Customers.Seller", "Seller")
                        .WithMany()
                        .HasForeignKey("SellerId");

                    b.HasOne("Core.Models.Ordering.OrderShipping", "Shipping")
                        .WithMany()
                        .HasForeignKey("ShippingId");

                    b.HasOne("Core.Models.Ordering.OrderStatus", "Status")
                        .WithMany()
            ...
            modelBuilder.Entity("Core.Models.Ordering.OrderItem", b =>
                {
                    b.HasOne("Core.Models.Ordering.Order", "Order")
                        .WithMany("Items")
                    ...
                    b.HasOne("Core.Models.Products.ProductVariation", "ProductVariation")
                        .WithMany()
            ...
            modelBuilder.Entity("Core.Models.Ordering.OrderItemDiscount", b =>
                {
                    b.HasOne("Core.Models.Ordering.OrderItemDiscountType", "DiscountType")
                        .WithMany()
                        .HasForeignKey("DiscountTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Core.Models.Ordering.OrderItem", "OrderItem")
            ...
            modelBuilder.Entity("Core.Models.Ordering.OrderShipping", b =>
                {
                    b.HasOne("Core.Models.Geography.Address", "Address")
                        .WithMany()
            ...
            modelBuilder.Entity("Core.Models.Payments.Payment", b =>
                {
                    b.HasOne("Core.Models.Payments.PaymentType", "PaymentType")
                        .WithMany()
                        .HasForeignKey("PaymentTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Core.Models.Payments.PaymentStatus", "Status")
                        .WithMany()
                        .HasForeignKey("StatusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Core.Models.Payments.PaymentTransaction", b =>
                {
                    ...
                    b.HasOne("Core.Models.Payments.PaymentTransactionStatus", "Status")
                        .WithMany()
                        .HasForeignKey("StatusId");

                    b.HasOne("Core.Models.Payments.PaymentTransactionSupplierCodeType", "SuplierReturn")
                        .WithMany()
            ...
            modelBuilder.Entity("Core.Models.Products.ProductCategory", b =>
                {
                    b.HasOne("Core.Models.Products.Category", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("Core.Models.Products.ProductSpecification", b =>
                {
                    ...
                    b.HasOne("Core.Models.Products.ProductSpecificationType", "Type")
                        .WithMany()
