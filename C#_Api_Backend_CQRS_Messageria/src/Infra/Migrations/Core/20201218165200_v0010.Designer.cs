...
namespace Infra.Migrations
{
    ...
    [Migration("20201218165200_v0010")]
    partial class v0010
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Models.Core.Marketing.CustomerNotification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Core.Models.Core.Ordering.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Models.Core.Ordering.Order", b =>
                {
                    ...
                    b.HasOne("Core.Models.Core.Payments.Payment", "Payment")
                        .WithOne("Order")
                        .HasForeignKey("Core.Models.Core.Ordering.Order", "PaymentId");
            ...
            modelBuilder.Entity("Core.Models.Core.Ordering.OrderItem", b =>
                {
                    b.HasOne("Core.Models.Core.Ordering.Order", "Order")
                        .WithMany("Items")
