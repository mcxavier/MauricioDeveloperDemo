...
namespace Infra.Migrations
{
    ...
    [Migration("20220616124143_Insights_GenericAndWhatsApp")]
    partial class Insights_GenericAndWhatsApp
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Domains.Insights.InsightData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("InsightTypeId");

                    b.ToTable("InsightData","insights");
                });
            ...
            modelBuilder.Entity("Core.Models.Core.Insights.InsightDataType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Models.Core.Products.Stock", b =>
                {
                    ...
                    b.HasAlternateKey("StockKeepingUnit", "StoreCode")
                        .HasName("UniqueStockRegister");
            ...
            modelBuilder.Entity("Core.Domains.Insights.InsightData", b =>
                {
                    b.HasOne("Core.Models.Core.Insights.InsightDataType", "InsightType")
                        .WithMany()
                        .HasForeignKey("InsightTypeId")
