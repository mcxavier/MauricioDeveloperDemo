...
{
    public class LinxUxFulllfilment
    {
        [JsonProperty("id")]
        ...
        public LinxUxShipment Shipment { get; set; }
        ...
        public LinxUxFreightCosts FreightCosts { get; set; }
        ...
        [JsonProperty("totals")]
        public LinxUxTotals Totals { get; set; }

        [JsonProperty("items")]
        public Dictionary<string, LinxUxItem> Items { get; set; }
        ...
        public LinxUxVolumes[] Volumes { get; set; }
        ...
        public LinxUxStatusHistory[] StatusHistory { get; set; }
